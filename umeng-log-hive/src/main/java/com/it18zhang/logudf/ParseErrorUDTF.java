...
public class ParseErrorUDTF extends GenericUDTF {
    ...
    private List<String> fields = fieldsCopy(AppErrorLog.class);
    private List<JavaStringObjectInspector> ois = OICopy(AppErrorLog.class);
    ...
    public void process(Object[] record) throws HiveException {
        ...
        String errorJson = ParseLogUtil.parseError(arr[4]);
